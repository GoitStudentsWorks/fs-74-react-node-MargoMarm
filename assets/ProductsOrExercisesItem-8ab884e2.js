...
`,pt=n.span`
  ...
  line-height: 150%;
  color: ${i.white};
`;function ce({data:t,addExercise:e}){const{_id:r,burnedCalories:s,name:l,bodyPart:a,gifUrl:c,target:x,equipment:u,time:j}=t,[y,m]=p.useState(0),[g,k]=p.useState(0),[S,$]=p.useState(!1),[b,w]=p.useState(null),v=te(),f=(C,M,R)=>{const B=Math.floor(R*C/(M*60));m(B)};p.useEffect(()=>{f(s,j,g)},[s,j,g]);const T=()=>{k(C=>C+1)},W=()=>{const C=setInterval(T,1e3);w(C),$(!0),v(U(!0))},L=()=>{$(!1),clearInterval(b),w(null)},P=re(new Date),q=({remainingTime:C})=>{const M=Math.floor(C/60).toString().length>1?Math.floor(C/60):"0"+Math.floor(C/60),R=(C%60).toString().length>1?C%60:"0"+C%60;return o.jsxs(pt,{children:[M,":",R]})};return o.jsxs(st,{children:[o.jsxs(at,{children:[o.jsx(nt,{children:o.jsx(lt,{src:c,alt:"gif of exercise"})}),o.jsx(ae,{startExercise:W,stopExercise:L,countCalory:f,calory:y,writeTime:q,isPlaying:S})]}),o.jsxs(ct,{children:[o.jsxs(D,{children:[o.jsx(A,{children:"Name"}),o.jsx(O,{children:E(l)})]}),o.jsxs(D,{children:[o.jsx(A,{children:"Target"}),o.jsx(O,{children:E(x)})]}),o.jsxs(D,{children:[o.jsx(A,{children:"Body Part"}),o.jsx(O,{children:E(a)})]}),o.jsxs(D,{children:[o.jsx(A,{children:"Equipment"}),o.jsx(O,{children:E(u)})]}),o.jsxs(D,{children:[o.jsx(A,{children:"Time"}),o.jsxs(O,{children:[j," minutes"]})]})]}),o.jsx(dt,{children:o.jsx(ie,{disabled:!(y>10),type:"button",onClick:()=>{e({id:r,date:P,time:g,burnedCalories:y}),v(U(!1))},children:"Add to diary"})})]})}ce.propTypes={data:d.object.isRequired,addExercise:d.func};oe.defaults.baseURL="https://power-pulse-rest-api.onrender.com";const ht=xe("addProduct",async(t,{rejectWithValue:e})=>{try{await oe.post("/api/diary/add-product",t)}catch{return ge.error("Oops... Something went wrong! Try again!"),e("Oops... Something went wrong!")}}),ut=(t,e)=>{let r=24;return e<768?r=23:e<1440&&(r=19),t.length<=r?t:t.substring(0,r)+"..."},xt=n.div`
  display: flex;
  flex-direction: column;
  width: 190px;
`,gt=n.img`
...
`,vt="/fs-74-react-node-MargoMarm/assets/foodIcon-f93b792c.png",jt="/fs-74-react-node-MargoMarm/assets/thumbUp-e8c8bf67.png";function G({modalType:t,data:e,btnNext:r}){const s=a=>{if(a==="time")return"Your  time:   ";if(a==="burnedCalories")return"Burned calories:    ";if(a==="calories")return"Calories: "},l=a=>Object.keys(a).map(u=>o.jsx("li",{children:o.jsxs(bt,{children:[`${s(u)} `,o.jsxs(wt,{children:[u==="time"&&`${a[u]} seconds`," ",u==="burnedCalories"&&`${a[u]}`," ",u==="calories"&&`${a[u]}`," "]})]})},me()));return o.jsxs(xt,{children:[o.jsx(gt,{src:t==="product"?vt:jt,alt:"it`s a placeholder image, but it`s avocado too"}),o.jsx(ft,{children:"Well Done"}),o.jsx(mt,{children:l(e)}),o.jsx(we,{title:t==="product"?"Next product":"Next exercise",btnNext:r}),o.jsxs(yt,{to:"/diary",children:["To the diary",o.jsx($t,{fill:"",children:o.jsx("use",{href:I+"#arrow-right"})})]})]})}G.propTypes={modalType:d.oneOf(["product","exercise"]),data:d.object.isRequired,btnNext:d.func};const Bt=t=>t.exercises.items,Dt=t=>t.exercises.getFilters,At=t=>t.exercises.isLoading,Ot=t=>t.exercises.hasMore,qt=t=>t.exercises.searchParams,Ct=t=>t.exercises.isTimerOn,kt=({page:t,data:e})=>{const[r,s]=p.useState(window.innerWidth),[l,a]=p.useState(!1),[c,x]=p.useState(!1),[u,j]=p.useState(0),[y,m]=p.useState(0),[g,k]=p.useState(0),S=ee(Ct),$=()=>{a(L=>!L),document.body.classList.toggle("body-scroll-lock")},b=()=>{x(L=>!L),document.body.classList.toggle("body-scroll-lock")},w=te();p.useEffect(()=>(window.addEventListener("resize",v),()=>{window.removeEventListener("resize",v)}),[]);const v=()=>{s(window.innerWidth)},f=$e(t,e),T=({id:L,date:P,amount:q,calories:C,time:M,burnedCalories:R})=>{if(t==="product"){const B={productId:L,date:P,amount:q,calories:C};j(C),w(ht(B))}if(t==="exercise"){const B={exerciseId:L,date:P,time:M,burnedCalories:R};if(!M||!R)return;m(M),k(R),w(be(B))}$(),b()},W=()=>{S?ye.Confirm.show("Warning","Do you really want to exit? You will lost all of your progress.","Yes","No",()=>{w(U(!1)),$()},()=>{},{backgroundColor:"#2f2e2e",titleColor:`${i.orange}`,messageColor:`${i.orangeSecondary}`,okButtonBackground:`${i.orange}`}):$()};return o.jsxs(Te,{children:[o.jsxs(Le,{children:[o.jsx(Se,{children:f.subtitle}),t==="product"&&o.jsx(Ee,{reccomend:e.recommended,children:e.recommended?"Recommended":"Not recommended"}),o.jsxs(We,{onClick:$,children:[f.button,o.jsx(Pe,{children:o.jsx("use",{href:I+"#arrow-right"})})]})]}),o.jsxs(Me,{children:[o.jsx(Re,{children:o.jsx(ze,{children:o.jsx("use",{href:I+"#runningMan"})})}),ut(f.title,r)]}),o.jsxs(Ie,{children:[o.jsxs(F,{children:[f.text1,o.jsx(H,{children:f.subText1})]}),o.jsxs(F,{children:[f.text2,o.jsx(H,{children:f.subText2})]}),o.jsxs(F,{children:[f.text3,o.jsx(H,{children:f.subText3})]})]}),l&&o.jsxs(Y,{openModal:t==="product"?$:W,width:t==="product"?481:696,height:t==="product"?[285,286]:[505,550],children:[t==="product"&&o.jsx(se,{closeModal:$,data:e,addProduct:T}),t==="exercise"&&o.jsx(ce,{data:e,addExercise:T})]}),c&&o.jsxs(Y,{openModal:b,width:430,height:t==="product"?[389,428]:[402,408],children:[t==="product"&&o.jsx(G,{modalType:"product",data:{calories:u},btnNext:b}),t==="exercise"&&o.jsx(G,{modalType:"exercise",data:{time:y,burnedCalories:g},btnNext:b})]})]})};kt.propTypes={page:d.string,data:d.object,openModal:d.func};export{K as I,It as P,ke as S,zt as a,Rt as b,Pt as c,ve as d,kt as e,Bt as f,Mt as g,At as h,qt as i,Ot as j,Dt as s};
