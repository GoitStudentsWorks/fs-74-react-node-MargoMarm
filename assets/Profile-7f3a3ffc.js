import{n as r,m as n,c as s,G as V,a as L,Y as F,r as C,u as T,j as e,s as j,$ as G,P as a,a0 as H}from"./index-aaef3055.js";import{T as M}from"./Title-53f81ec4.js";import{D as $,a as P,m as z}from"./descriptionTextMargin-7c397340.js";import{F as Y,I as w,L as A,b as m,E as u,d as B,H as y,C as _,e as X,f as S,g as J,h as K,B as N}from"./Calendar-f7bc68a4.js";import{c as Q,b,e as k,f as Z,u as ee}from"./formik.esm-7710ef7a.js";import{s as U}from"./index-6a9717eb.js";function te(i,o){const p=Object.keys(i);let h=!0;return p.forEach(c=>{i[c]!=o[c]&&(h=!1)}),h}const re=r.div`
  flex-shrink: 0;
  max-width: 439px;
  margin: 0 auto;
  ${n.desktop} {
...
`;function R({setAvatar:i}){const{name:o,avatarURL:p,dailyСalories:h,dailyTime:c}=L(F),[d,x]=C.useState(p||null),g=T(),f=v=>{x(URL.createObjectURL(v.target.files[0])),i(v.target.files[0]),URL.revokeObjectURL(d)};return e.jsxs(re,{children:[e.jsxs(ie,{children:[d?e.jsx(se,{children:e.jsx(ne,{src:d})}):e.jsx(ae,{children:e.jsx("use",{href:`${j}#icon-gridicons_user`})}),e.jsxs(oe,{children:[e.jsx("input",{type:"file",onChange:f}),e.jsx("svg",{children:e.jsx("use",{href:`${j}#icon-check-mark`})})]})]}),e.jsx(le,{children:o||"user"}),e.jsxs(de,{children:[e.jsx(D,{children:e.jsx($,{icon:"fork-and-knife",keyValue:(h||"0")+"",label:"Daily calorie intake",fill:"true"})}),e.jsx(D,{children:e.jsx($,{icon:"dumbbell",keyValue:(c||0)+" min",label:"Daily norm of sports",fill:"true"})})]}),e.jsx(P,{margin:z,text:"We understand that each individual is unique, so the entire approach to diet is relative and tailored to your unique body and goals.",width:{tablet:439,desktop:439}}),e.jsxs(he,{type:"button",onClick:()=>{G(g)},children:[e.jsx("span",{children:"Logout"}),e.jsx("svg",{children:e.jsx("use",{href:`${j}#logout_`})})]})]})}R.propTypes={setAvatar:a.func.isRequired};const ce=r.label`
  display: inline-flex;
  align-items: center;
  position: relative;
